...
from app.serializers import UsersListeSerializer, UsersDetailsSerializer, ImagesListeSerializer
...
class ImagesAPIViewSet(ModelViewSet):
    serializer_class = ImagesListeSerializer
